    ...
    <div class="container">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <button type="button" class="btn btn-secondary" name="submit"
                            wire:click="clearData()">CLEAR</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            @if ($employee_selected_id)
                <a wire:click="delete_confirm('')" class="btn btn-danger btn-sm mb-3" data-bs-toggle="modal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tida</button>
